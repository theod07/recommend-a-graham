...
def get_page(user, driver, sleeptime=1, down_scrolls=0):
    '''
    '''
...
if __name__ == '__main__':
    ...
    profile.set_preference("browser.download.dir", '/Users/wonder/galvanize/project/recommend-a-graham/data')
    ...
    for user in users:
        ...
        with open('logs/log_scrape_users.txt', 'ab') as f:
            f.write('{} saved page for {}'.format(strftime('%Y%m%d.%H:%M:%s'), user))
